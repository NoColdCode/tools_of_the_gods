...
public final class TogArmorMaterials {
	...
	public static final TagKey<Item> REPAIRS_DIVINE_ARMOR = TagKey.create(
		...
		ResourceLocation.fromNamespaceAndPath(TogModConstants.MODID, "repairs_divine_armor")
	);
	...
	public static final ResourceKey<EquipmentAsset> AERIAL_ASSET_KEY = ResourceKey.create(
		EquipmentAssets.ROOT_ID,
		ResourceLocation.fromNamespaceAndPath(TogModConstants.MODID, "aerial")
	);
	...
	public static ArmorMaterial createAerialMaterial() {
		return new ArmorMaterial(
			...
			0.0F,
			0.0F,
			TagKey.create(BuiltInRegistries.ITEM.key(), ResourceLocation.fromNamespaceAndPath(TogModConstants.MODID, "repairs_aerial_armor")),
			AERIAL_ASSET_KEY
		);
	}
