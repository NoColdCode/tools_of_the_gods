...
public class PrimalWoodenToolsShovelItem extends Item {
	public PrimalWoodenToolsShovelItem(ResourceKey<Item> itemId) {
		super(new Item.Properties().setId(itemId).shovel(TogToolMaterials.PRIMAL, 0f, -3f).fireResistant());
	}
