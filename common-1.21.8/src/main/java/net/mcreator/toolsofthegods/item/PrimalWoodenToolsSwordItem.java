...
public class PrimalWoodenToolsSwordItem extends Item {
	public PrimalWoodenToolsSwordItem(ResourceKey<Item> itemId) {
		super(new Item.Properties().setId(itemId).sword(TogToolMaterials.PRIMAL, 0f, -3f).fireResistant());
	}
