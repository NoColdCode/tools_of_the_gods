...
public final class FlailCombatHelper {
	...
	public static int getLevel(ItemStack stack) {
		return (int) stack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getDoubleOr("level", 0.0);
	}
	...
	public static void applyStun(LivingEntity target, int level) {
		...
		target.addEffect(new MobEffectInstance(MobEffects.SLOWNESS, ticks, 6, false, true, true));
		target.addEffect(new MobEffectInstance(MobEffects.JUMP_BOOST, ticks, 200, false, true, true));
