...
public final class TogToolMaterials {
	private static final TagKey<Item> REPAIRS_PRIMAL = TagKey.create(
		...
		ResourceLocation.fromNamespaceAndPath(TogModConstants.MODID, "repairs_primal_tools")
	);

	private static final TagKey<Item> REPAIRS_ULTIMATE = TagKey.create(
		BuiltInRegistries.ITEM.key(),
		ResourceLocation.fromNamespaceAndPath(TogModConstants.MODID, "repairs_ultimate_tool")
	);
