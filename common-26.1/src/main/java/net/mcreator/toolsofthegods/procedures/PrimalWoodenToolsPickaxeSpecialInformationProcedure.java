...
public class PrimalWoodenToolsPickaxeSpecialInformationProcedure {
	public static String execute(ItemStack itemstack) {
		...
		} else if (type == ToolProgressionHelper.ToolType.ARMOR && itemstack.getItem() instanceof ArmorOfTheGodsItem armorItem) {
			tooltip.append("§7Armor: §9").append(String.format("%.1f", ToolProgressionHelper.getArmorDefensePoints(itemstack, armorItem.getArmorType())));
