...
public final class ToolsOfTheGodsCommonConfig {
	...
	public static final ForgeConfigSpec.DoubleValue XP_EXPONENT_BASE;
	public static final ForgeConfigSpec.DoubleValue XP_EXPONENT_PER_LEVEL;
	public static final ForgeConfigSpec.DoubleValue XP_REQUIRED_MULTIPLIER;
	public static final ForgeConfigSpec.DoubleValue GLOBAL_XP_GAIN_MULTIPLIER;
	public static final ForgeConfigSpec.DoubleValue MINING_XP_GAIN_MULTIPLIER;
	public static final ForgeConfigSpec.DoubleValue COMBAT_XP_GAIN_MULTIPLIER;
	public static final ForgeConfigSpec.DoubleValue SWORD_XP_PACE_DIVISOR;
	public static final ForgeConfigSpec.DoubleValue HOE_XP_PACE_DIVISOR;
	public static final ForgeConfigSpec.DoubleValue BOW_XP_PACE_DIVISOR;
	public static final ForgeConfigSpec.DoubleValue SHIELD_XP_PACE_DIVISOR;

	public static final ForgeConfigSpec.DoubleValue SHIELD_BLOCK_CHANCE_MIN;
	public static final ForgeConfigSpec.DoubleValue SHIELD_BLOCK_CHANCE_MAX;
	public static final ForgeConfigSpec.IntValue ARMOR_WEAR_XP_INTERVAL;
	public static final ForgeConfigSpec.BooleanValue TIER_PARTICLES_ENABLED;
	public static final ForgeConfigSpec.BooleanValue EXTENDED_TOOLS_ENABLED;
	public static final ForgeConfigSpec.BooleanValue CREATIVE_TIER_PREVIEWS_ENABLED;
