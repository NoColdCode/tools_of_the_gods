...
public class ToolsOfTheGodsMod {
	...
	public ToolsOfTheGodsMod(IEventBus modEventBus) {
		...
		ToolsOfTheGodsModBlocks.REGISTRY.register(modEventBus);
		ToolsOfTheGodsModBlockEntities.REGISTRY.register(modEventBus);
		ToolsOfTheGodsModItems.REGISTRY.register(modEventBus);
		net.mcreator.toolsofthegods.init.TogIngredientTypes.REGISTRY.register(modEventBus);
		ToolsOfTheGodsModMenus.REGISTRY.register(modEventBus);
		ToolsOfTheGodsOrbItems.REGISTRY.register(modEventBus);
		ToolsOfTheGodsModTabs.REGISTRY.register(modEventBus);
		ToolsOfTheGodsModMobEffects.REGISTRY.register(modEventBus);
		net.mcreator.toolsofthegods.init.TogArmorMaterials.REGISTRY.register(modEventBus);
		net.mcreator.toolsofthegods.init.TogModFeatures.REGISTRY.register(modEventBus);
		// Start of user code block mod init
		// Register client-side texture handler
		modEventBus.addListener(this::initClient);
		// End of user code block mod init
	}

	// Start of user code block mod methods
	private void initClient(net.neoforged.fml.event.lifecycle.FMLClientSetupEvent event) {
		event.enqueueWork(() -> {
			net.mcreator.toolsofthegods.client.DynamicTextureHandler.init();
