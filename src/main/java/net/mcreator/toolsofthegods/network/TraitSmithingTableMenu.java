...
public class TraitSmithingTableMenu extends AbstractContainerMenu {
	...
	private static final int TOOL_SLOT_Y = 47;
	private static final int INGREDIENT_SLOT_X = 76;
	private static final int INGREDIENT_SLOT_Y = 47;
	private static final int PLAYER_INV_START_X = 8;
	private static final int PLAYER_INV_START_Y = 117;
	private static final int HOTBAR_START_Y = 175;
	...
	public boolean clickMenuButton(Player player, int id) {
		...
		boolean applied = TraitSystem.bindNextTrait(toolStack, ingredientStack);
		if (applied) {
